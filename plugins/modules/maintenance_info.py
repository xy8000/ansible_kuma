...
- name: get all maintenances
  xy8000.uptime_kuma.maintenance_info:
...
from ansible_collections.xy8000.uptime_kuma.plugins.module_utils.common import common_module_args, get_maintenance_by_title
